...
There is also a `paper <https://arxiv.org/abs/2103.07388>`__ with more
maths inside. It can be used to
`cite <https://dblp.org/rec/journals/corr/abs-2103-07388.html?view=bibtex>`__
the package.

To reproduce results from the paper, use `this
